...
\begin{enumerate}
	...
	\item  	Zwei $\sigma$-Strukturen $(\mathcal{A},\mathcal{B})$ sind isomorph, wenn es eine Bijektion $f$ zwischen diesen existiert und $f$ ein Homomoprhismus ist.
\end{enumerate}
\textbf{Beweis:}
\begin{enumerate}
