...
\begin{enumerate}
	...
	Sei $m \in \N$ ein beliebig. Wählt der Herausforderen ein Tupel $a_n$, die Unendlichkeit nicht enthält, so wählt die Duplikatorin genau das gleiche Element in der anderen Struktur. Dadurch entsteht logischerweise ein Homomorphismus.\\
