...
<<<<<<< HEAD
		\[\varphi_3 = \bigwedge_{1 \le i <n}~ \left(\bigvee_{\{k,l\} \in E(G)} X_{i,k} \land X_{i+1,l} \right) \land \bigvee_{\{k,l\} \in E(G)} X_{0,k} \land X_{n,l}\]
...
>>>>>>> fecfd4bc3f02e3a1efdf3d8f42ae9695a34eb854
\end{enumerate}
\begin{tabular}{@{} p{\tabspace}}
